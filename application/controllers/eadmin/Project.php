...
class Project extends CI_Controller {
	...
	{
        $this->Createtable->location('eadmin/project/table_show');
        $this->Createtable->table_name('tableku');
        $this->Createtable->create_row(["no","nama","tanggal","keterangan","status", "action"]);
        $this->Createtable->order_set('0, 5');
		$show = $this->Createtable->create();

		$data['datatable'] = $show;
        $this->load->view('templateadmin/head');
        $this->load->view('eadmin/project/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('eadmin/project/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('eadmin/project/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$status = post("status");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-project.xlsx')
    {
        ...
        $headers = ["no","nama","tanggal","keterangan","status", "action"];
