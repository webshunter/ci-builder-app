<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah Theater</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('eadmin/theaters/update') ?>" method="post" enctype="multipart/form-data">
        ...
        ?>
                ...
                <?=
                    form::input([
                        ...
                        "value" => $form_data->studio,
                    ])
                ?>
            
                        <div class="form-group">
                          <button type="submit" class="btn btn-primary">Simpan</button>
                          <a class="btn btn-default" href="<?= site_url('eadmin/theaters'); ?>">Back</a>
                        </div>
                    </form>
                </div>
            </div>
